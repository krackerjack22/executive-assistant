...
4. Send the events wrapped in a "data" field to the webhook action.
...
📌 Always analyze the full input — including visual content in images or PDFs — and respond by sending the object to the sendCalendarData action.
