...
4. Send the array of events directly as the payload — do not wrap them in a "data" field.
...
Return all events as elements of a raw array. Do not include a top-level object or wrapper field.

📌 Always analyze the full input — including visual content in images or PDFs — and respond by sending raw JSON directly to the `sendCalendarData` action.
